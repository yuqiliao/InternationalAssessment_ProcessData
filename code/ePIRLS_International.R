...
ePIRLS <- read_ePIRLS("/Users/Yuqi/Desktop/Files/AIR/Conference/Conference 2020/ePIRLS/data/eP16_International/eP16_SPSSData/", countries = c( "can", "usa"))
...
#allvars <- c("en11madz", "en11radz", "en11badz", "en11zadz", "en11tadz")
...
View(ePIRLS_lesdf_cnt1$en11mitem) #last item is 20
View(ePIRLS_lesdf_cnt1$en11ritem) #16
View(ePIRLS_lesdf_cnt1$en11bitem) #17
View(ePIRLS_lesdf_cnt1$en11zitem) #20
View(ePIRLS_lesdf_cnt1$en11titem) #18
View(ePIRLS_lesdf_cnt1$rotation) 
...
output2 <- edsurveyTable(formula = erea ~ itsex,
                        data = ePIRLS,
                        jrrIMax = Inf)
output2
...
#View(ePIRLS_lesdf_cnt1_new3$en11madz_d_clicked)
